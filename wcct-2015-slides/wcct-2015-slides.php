 ...
 * @since             1.0.0
 * @package           Wcct_2015_Slides
 *
 * @wordpress-plugin
 * Plugin Name:       WordCamp Cape Town 2015 Slides
 * Plugin URI:        https://github.com/jeffikus/wcct-2015-plugins
 * Description:       Extended functionality for WP-API for my WCCT 2015 slides to function.
 * Version:           1.0.0
 * Author:            Jeffikus
 * Author URI:        http://jeffikus.com
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       wcct-2015-slides
